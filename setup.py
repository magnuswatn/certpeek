...
def get_version():
    main_file = os.path.join(CURDIR, "certpeek.py")
...
setup(
    ...
    version=get_version(),
    author="Magnus Watn",
    author_email="magnus@watn.no",
    description="Peeks at certificates exposed by other hosts.",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/magnuswatn/certpeek",
    py_modules=["certpeek"],
    include_package_data=True,
    keywords=[],
    scripts=[],
    entry_points={"console_scripts": ["certpeek=certpeek:main"]},
    zip_safe=False,
